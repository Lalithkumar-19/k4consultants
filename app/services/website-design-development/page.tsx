...
const SUB_SERVICES = [
    {
        ...
        description: "We create cost-effective, user-friendly websites for small businesses that showcase your products or services and engage your local audience."
    },
    {
        id: "02",
        title: "Ecommerce Websites",
        description: "Our ecommerce solutions are designed to help you sell products or services online efficiently. We focus on user experience, security, and conversion optimization."
    },
    {
        id: "03",
        title: "Corporate Web Solutions",
        description: "Creating an appealing corporate website design is a vital means of communicating business information to clients."
    }
]
            ...
            <div className="bg-slate-50 border-y border-slate-100 py-12 mb-16">
                <div className="container px-4 md:px-8 max-w-7xl mx-auto text-center">
                    <div className="flex items-center justify-center gap-2 text-sm text-slate-500 mb-4 font-medium uppercase tracking-wide">
                        ...
                        <ChevronRight className="w-4 h-4" />
                        <span className="text-blue-600">Website Design & Development</span>
                    </div>
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-24">
                    ...
                    >
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6 leading-tight">
                            Creating Digital Greatness for <span className="text-blue-600">All Business Requirements</span>
                        </h2>
                        <p className="text-lg text-slate-600 leading-relaxed mb-6">
                            We at <span className="font-semibold text-slate-900">K4Consultants</span> are aware that your website serves as the online representation of your company.
                        </p>
                        <p className="text-lg text-slate-600 leading-relaxed">
                            Our web design and development services are customized to meet your unique needs, whether you’re a corporate entity seeking to revitalize your online presence, a startup in the making, or an established e-commerce platform.
                        </p>
                    </motion.div>
